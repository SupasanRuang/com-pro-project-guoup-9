...
void start(){
    ...
    while(done){
        ...
        cout <<setw(10)<<"|"<<"  3.bill ( press 3 )"<<setw(26) <<"|"<<setw(40)<<" | what would you choose ?  |"<<endl ;
        ...
        switch (select)
        {
            ...
            case 6:
                ...
                for(int i=0;i<9;i++)
                {
                    ...
                    {   
                        cout<<setw(108)<<"--------------------------------------------------------------------------------------------------------\n";
                        cout<<setw(80)<< " All table aren't empty ,plese pay first before exit."<<endl;
                        cout<<setw(108)<<"--------------------------------------------------------------------------------------------------------\n";
                        ending=true;
                    }
                }
...
void loop_order(vector<table_order> &thetable){
    ...
    while (true)
    {
        ...
        switch (num)
        {
            case 1 :
                cout<<setw(108)<<"--------------------------------------------------------------------------------------------------------\n";
                cout<<setw(65)<<"[1] Add Order Process"<<endl;
                cout<<setw(108)<<"--------------------------------------------------------------------------------------------------------\n";
            ...
            case 2 :
                cout<<setw(108)<<"--------------------------------------------------------------------------------------------------------\n";
                cout<<setw(66)<<"[2] Cancel Order Process"<<endl;
                cout<<setw(108)<<"--------------------------------------------------------------------------------------------------------\n";
            ...
            case 3 :
                cout<<setw(108)<<"--------------------------------------------------------------------------------------------------------\n";
                cout<<setw(68)<<"[3] Exit Order Food Process"<<endl;
                cout<<setw(108)<<"--------------------------------------------------------------------------------------------------------\n";
                return ;
                break;
...
void number_table_order(int tb_num=0){ 
    ...
    if(tb_num==0) 
    {
        ...
        {
            cout<<setw(108)<<"---------------------------------------------------\n";
            cout<<setw(95)<<"please select table first." <<"\n"; 
            cout<<setw(108)<<"--------------------------------------------------------------------------------------------------------\n";
            return;
        }
        while(true) 
